...
import Car from '../models/Car.js' // Importar o model de validação
...
controller.create = async function(req, res) {
  try {
    ...
    // Converte selling_price para número, se existir
    if(req.body.selling_price !== undefined && req.body.selling_price !== null) {
      req.body.selling_price = Number(req.body.selling_price)
    }

    // Converte imported para booleano
    if(req.body.imported !== undefined) {
      req.body.imported = Boolean(req.body.imported)
    }
